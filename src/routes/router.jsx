...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "class/:id",
                element: <SingleClass/>,
                loader: ({ params }) => fetch(`https://yoga-master-server-gri8.onrender.com/class/${params.id}`),
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://yoga-master-server-gri8.onrender.com/users/${params.id}`),
            },
            {
                path: 'admin-home',
